        ...
        <div id="visual">
            <div class="slide-visual">
               <ul class="slide-group">
                    <li><img class="img-responsive" src="images/vegetable.png" alt="vegetable Image" /></li>
                    <li><img class="img-responsive" src="images/fertilizer.png" alt="pesticide Image" /></li>
                    <li><img class="img-responsive" src="images/pic1 (1).png" alt="seeds Image" /></li>
                </ul>
                <!--<div class="script-wrap">
                    <ul class="script-group">
                        <li><div class="inner-script">
                                <img class="img-responsive" src="images/vegetable.png" alt="vegetable Image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="images/pesticide.png" alt="pesticide image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="images/seeds.png" alt="seeds image" />
                            </div></li>
                    </ul>-->
